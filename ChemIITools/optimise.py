# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/03_Optimisation.ipynb.

# %% auto 0
__all__ = ['steady_state_calc', 'oreg_calc']

# %% ../nbs/03_Optimisation.ipynb 2
#| echo: false
import os
import re
import linecache
...
def _deriv(t, concs, k1, k2, k3, k4, k5):
    ...
    Adot = -A*Y*k1
    Bdot = -B*X*k3
    Xdot =A*Y*k1-X*Y*k2+B*X*k3-X*X*k4
